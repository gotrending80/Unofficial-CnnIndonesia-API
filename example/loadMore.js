...
$(function(){
    $('.loading[href]').each(function(){
        ...
        _this.loadMore({
            ...
            {
                var params = {};
                if ( typeof _this.attr('d:date') !== 'undefined' )
                {
                    params.date = _this.attr('d:date');
                }
                if ( typeof _this.attr('d:kanal') !== 'undefined' )
                {
                    params.kanal = _this.attr('d:kanal');
                }
                if ( typeof _this.attr('d:kolom') !== 'undefined' )
                {
                    params.kolom = _this.attr('d:kolom');
                }
                if ( typeof _this.attr('d:query') !== 'undefined' )
                {
                    params.query = _this.attr('d:query');
                }
                return params;
            },
